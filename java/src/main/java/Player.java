...
public class Player extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            resp.getWriter().println("<img id=picture src=" + pictureName + " onclick=makebig() style=width:250px;height:250px;position:fixed;top:300px;left:5px;>");
            ...
            resp.getWriter().println("<ul style=padding-left:265px;font-size:150%;line-height:180%;list-style-type:circle;>");
        } catch (IOException e) {
            e.printStackTrace();
        }
